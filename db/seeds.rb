...
Worker.create(first_name: "Gay", last_name: "Garner", contact: "(564) 229-9507", email: "consequat.dolor@gmail.com", type: "Employee",company_id:"")
Worker.create(first_name: "Vaughan", last_name: "Sanford", contact: "(598) 953-1160", email: "rutrum.eu@domain.net", type: "Employee", company_id:"")
...
Worker.create(first_name: "Abraham", last_name: "Meritt", contact: "(951) 205-4225", email: "cubilia@Nunc.com", type: "Contractor", company_id: "")
Worker.create(first_name: "Rhona", last_name: "Stevenson", contact: "(867) 998-0298", email: "ante.dictum@interdum.edu", type: "Employee", company_id: "")
Worker.create(first_name: "Keefe", last_name: "Key", contact: "(707) 626-8002", email: "pellentesque@libero.edu", type: "Contractor", company_id: "")
Worker.create(first_name: "Drew", last_name: "Kaufman", contact: "(329) 556-5294", email: "ac.mattis@nascet.com", type: "Employee", company_id: "")
Worker.create(first_name: "Aimee", last_name: "Christen", contact: "(464) 733-7165", email: "risus@est.com", type: "Contractor", company_id: "")
Worker.create(first_name: "Jane", last_name: "Garner", contact: "(393) 217-2402", email: "Quisque@liberoest.org", type: "Employee", company_id: "")
Worker.create(first_name: "Evan", last_name: "Peters", contact: "(920) 221-1805", email: "magna.vel@mumet.net", type: "Employee", company_id: "")
Worker.create(first_name: "Imani", last_name: "Le", contact: "(450) 751-6269", email: "mollis.libero@interdum.edu", type: "Contractor", company_id: "")
Worker.create(first_name: "Ciaro", last_name: "Stuart", contact: "(237) 474-1951", email: "Aliqua.liaculis@Aliquam.net", type: "Employee", company_id: "")
Worker.create(first_name: "Kelsie", last_name: "Graham", contact: "(606) 201-8560", email: "non@Maecenas.ca", type: "Contractor", company_id: "")
Worker.create(first_name: "Carol", last_name: "Mosley", contact: "(393) 193-7968", email: "diam.ullamcorper@turps.edu", type: "Employee", company_id: "")
Worker.create(first_name: "Charlotte", last_name: "Ferguson", contact: "(715) 787-1924", email: "arcu.et@ultriciesligula.ca", type: "Contractor", company_id: "")
Worker.create(first_name: "Gray", last_name: "Ward", contact: "(133) 223-8023", email: "vitae@suscipitestac.co.uk", type: "Contractor", company_id: "")
Worker.create(first_name: "Imelda", last_name: "Vance", contact: "(517) 685-9809", email: "Etiam.laoreet@vinara.edu", type: "Manager", company_id: "")
